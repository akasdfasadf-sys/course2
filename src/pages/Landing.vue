<template>
  <div class="min-h-screen bg-white">
    ...
    <!-- Footer -->
    <footer v-bm-reveal:up class="bg-gray-950 text-gray-400 py-10 md:py-12">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="flex items-center justify-center gap-2 mb-4">
          ...
          <span class="text-lg md:text-xl font-bold text-white">Bilim Merkezi</span>
        </div>
        <p class="text-sm md:text-base text-gray-500">© 2026 Bilim Merkezi. Ähli hukuklar goragly.</p>
      </div>
    </footer>
  </div>
</template>
